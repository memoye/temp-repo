...
import { InputBase, InputBaseControl, InputBaseInput } from "@/components/ui/input-base";
...
const dateTimeFieldInputStyle =
  "focus:bg-secondary focus:text-secondary-foreground focus:placeholder:text-secondary-foreground box-content h-fit flex-initial rounded-sm px-0.5 tabular-nums";
...
function DateTimeFieldYears({
  ...
  return (
    <InputBaseControl>
      ...
      >
        <InputBaseInput
          className={cn(dateTimeFieldInputStyle, "max-w-[calc(4ch_+_0.5rem)]", className)}
        />
      </DateTimeFieldPrimitive.Years>
    </InputBaseControl>
  );
...
function DateTimeFieldMonths({
  ...
  return (
    <InputBaseControl>
      ...
      >
        <InputBaseInput
          className={cn(dateTimeFieldInputStyle, "max-w-[calc(2ch_+_0.5rem)]", className)}
        />
      </DateTimeFieldPrimitive.Months>
    </InputBaseControl>
  );
