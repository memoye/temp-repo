...
export const editorTheme: EditorThemeClasses = {
  ...
  paragraph: "leading-7 text-sm [&:not(:first-child)]:mt-6",
  quote: "mt-6 border-l-2 pl-6 italic font-serif text-foreground/70",
  ...
  hashtag: "text-secondary-foreground/80 bg-secondary font-medium px-1 rounded-xs",
  text: {
    bold: "font-bold",
